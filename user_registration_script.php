<?php
    ...
    if($rows_fetched>0){
        ...
        $user_registration_query="insert into users(name,lname,Gender,Dob,email,password,contact,city,address) values ('$name','$lname','$Gender','$Dob','$email','$password','$contact','$city','$address')";
        //die($user_registration_query);
        $user_registration_result=mysqli_query($con,$user_registration_query) or die(mysqli_error($con));
        echo "User successfully registered. Welcome to ONLINE GROCERY WORLD";
        $_SESSION['email']=$email;
        //The mysqli_insert_id() function returns the id (generated with AUTO_INCREMENT) used in the last query.
        $_SESSION['id']=mysqli_insert_id($con); 
        //header('location: all.php');  //for redirecting
        ?>
